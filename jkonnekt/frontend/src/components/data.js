const data = [
    ...
    },
    {
        ...
        price: 1800, // Price in dollars
        images: [
          'https://images.unsplash.com/photo-1540575467063-178a50c2df87?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZXZlbnRzfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60',
          'https://example.com/grand_celebration_hall_2.jpg',
        ],
        location: 'Chicago, USA',
      },
    {
      ...
      description: 'An enchanting pavilion surrounded by lush gardens.',
      categories: ['event centers', 'decorations', 'general'],
      price: 2200, // Price in dollars
      images: [
        'https://example.com/royal_garden_pavilion_1.jpg',
        'https://example.com/royal_garden_pavilion_2.jpg',
      ],
      location: 'London, UK',
    },
    {
